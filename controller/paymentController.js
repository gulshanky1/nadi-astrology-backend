...
// Address: ${userDetails.address}, ${userDetails.city}, ${userDetails.postalCode}, ${userDetails.country}
...
//     res.status(200).json({ message: "Payment verified and confirmation sent." });
//   } catch (err) {
